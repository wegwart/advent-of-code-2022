...
def get_inspected_items(file_name, iterations):
...
def puzzle(file_name, iterations, verbose = False):
    inspected_items = get_inspected_items(file_name, iterations)
...
def test_puzzle():
    assert(puzzle(__location__ / 'day11_test.txt', iterations=20, verbose=True) == 10605) 
          
def print_puzzle():
    print(puzzle(__location__ / 'day11_puzzle.txt', iterations=20))
